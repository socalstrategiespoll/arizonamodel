...
_CONFIG = {
    "Maricopa":   dict(total=316289, early_share=0.7606, early_bso=(0.720, 0.246, 0.034), dayof_bso=(0.753, 0.213, 0.034), late_share=0.1188, late_bso=(0.753, 0.213, 0.034)),
    ...
    "Navajo":   dict(total=19000, early_share=0.3071, early_bso=(0.720, 0.237, 0.043), dayof_bso=(0.752, 0.205, 0.043)),
    "Coconino":   dict(total=10122, early_share=0.5167, early_bso=(0.718, 0.235, 0.047), dayof_bso=(0.751, 0.203, 0.046)),
    "Gila":   dict(total=13000, early_share=0.4326, early_bso=(0.757, 0.205, 0.038), dayof_bso=(0.790, 0.172, 0.038)),
    "Apache":   dict(total=6500, early_share=0.2977, early_bso=(0.713, 0.209, 0.078), dayof_bso=(0.745, 0.178, 0.077)),
    "Graham":   dict(total=7500, early_share=0.2999, early_bso=(0.725, 0.231, 0.044), dayof_bso=(0.757, 0.198, 0.045)),
    "La Paz":   dict(total=3000, early_share=0.3196, early_bso=(0.728, 0.211, 0.061), dayof_bso=(0.760, 0.178, 0.062)),
